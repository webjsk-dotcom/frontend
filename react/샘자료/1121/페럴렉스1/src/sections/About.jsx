      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            <div ref={textRef.ref} className="space-y-4 sm:space-y-6 order-2 md:order-1">
              ...
              <div className="flex justify-center sm:justify-start space-x-4 sm:space-x-6 pt-4">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-orange-500">50+</div>
                  <div className="text-xs sm:text-sm text-gray-600">프로젝트</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-orange-500">3+</div>
                  <div className="text-xs sm:text-sm text-gray-600">년 경력</div>
                </div>
                <div className="text-center">
            ...
            <ParallaxImage
              ...
              alt="About"
              speed={-20}
              className="h-64 sm:h-80 md:h-96 shadow-xl order-1 md:order-2"
            />
          </div>
        </div>
      </section>
