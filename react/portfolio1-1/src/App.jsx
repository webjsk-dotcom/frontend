  ...
  return (
    <div className='app'>
      ...
      <section ref={aboutRef} className='section section-about'>
        <div className="section-content">
          <h2 className="slide-in-left prof">Profile</h2>
          <p className="slide-in-left prof-txt">스크롤 할때마다 부드러운 효과가 적용됩니다.</p>
          ...
          <div className="cards">
            ...
            <div className="card card-fade det">
              <h2>Details</h2>
              <h3>Name</h3>
              <p>Joung Seo Kyoun</p>
              <h3>Age</h3>
            ...
            <div className="card card-fade">
              <h2>About Me</h2>
              <p>
                I'm a passionate full-stack developer with a love for creating beautiful and functional web applications. With expertise in modern technologies and a keen eye for design, I bring ideas to life.
              </p>
            </div>
