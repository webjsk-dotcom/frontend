...
import './hero.css';
// https://react-icons.github.io/react-icons/   -> icon소스가져올수있음.
...
export default function Hero() {
  ...
  //ID 가 contact인 요소를 찾아 부드럽게 스크롤해줌 
  //.scrollIntoView  화면이동
    ...
    <section id="home" className='hero'>
      ...
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          ...
          <button className="btn-secondary" onClick={() => window.open('/cv.pdf','_blank')}>  {/* /cv.pdf public인식*/}
            <FiDownload />
            Download CV
          </button>
        </div>
